...
export default function ContactDetails() {
    return (
        <>
            {/* <div  className="pt-20 mt-[-80px]"></div> */}
            <section id="contact-info-section" aria-labelledby="title-contact-info" className="bg-[#191d3c] mt-24 flex flex-col h-full bg-portfolio bg-cover bg-bottom text-stone-100 lg:rounded-lg page-width pb-6 pt-6 scroll-mt-32">
