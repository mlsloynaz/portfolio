...
export default function ContactDetails() {
    return (
        <>
            ...
            <section aria-labelledby="title-contact-info" className="bg-[#191d3c] mt-24 md:mb-24  flex flex-col h-full w-full bg-portfolio bg-cover bg-bottom text-stone-100 lg:rounded-lg  lg:max-w-[1024px] p-6 sm:px-12">
