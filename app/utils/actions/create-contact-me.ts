...
import {
    ...
    ResultType,
    ResultTypeEnum,
} from '@/definitions/contactMeTypes';
...
export async function createContactMe(
    ...
    if (!validatedFields.success) {
        return {
            ...
            result: {
                message: t.resultMessage.validationError,
    ...
    if (errorSendingEmails) {
        try {
            ...
            return {
                ...
                errors: {},
                result: {
                    message: t.resultMessage.infoSent,
            ...
            return {
                ...prevState,
                result: {
                    message: t.resultMessage.errorSendingEmail,
                    type: ResultTypeEnum.ERROR,
                },
            };
        }
    ...
    return {
        ...
        errors: {},
        result: {
            message: t.resultMessage.emailSent,
            type: ResultTypeEnum.SUCCESS,
        },
        resetKey: validatedFields.data.email,
    };
